...
export interface SeriesTrending extends Trending {}
...
export interface SeriesPopular extends TVSeries {}

export interface SeriesTopRated extends TVSeries {}
...
export interface SeriesSimilar {
  page: number;
